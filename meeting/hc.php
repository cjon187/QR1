...
//$q1="select date_format(time,'%l:%i %p %M %d %Y %W') as date, count(ip) as cash from file2 group by ip";

$q1="select ip as date, count(ip) as cash from file2 group by ip"; 
